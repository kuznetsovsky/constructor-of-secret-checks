...
router.get('/objects/:object_id', isCompanyAdminOrManager, objectsController.getObject)
router.put('/objects/:object_id', isCompanyAdminOrManager, validateBody(companyObjectValidator), objectsController.updateObject)
router.delete('/objects/:object_id', isCompanyAdminOrManager, objectsController.deleteObject)
